<?
  ...
  $login=new CLogin($db, $template, $acc);
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      <td bgcolor="#30353d" height="75px"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
        <tbody>
          <tr>
            <td width="3%">&nbsp;</td>
            <td width="36%">
            <a href="../../../index.php">
            <img src="../../template/GIF/logo.png" width="250" height="54" alt=""/>
            </a>
            </td>
