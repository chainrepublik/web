...
class CMining
{
	...
	function showPanels()
	{
		...
		// Mining reward
		$reward=$this->kern->getRewardPool("ID_MINER");
		?>
	...
	function showTopBar()
	{
		?>
            ...
            <br><br>
            <form method="post" name="form_miner" id="form_miner" action="main.php?act=<? if ($_REQUEST['sd']['mining_threads']) print "stop"; else print "start"; ?>">
            ...
            <tbody>
            <tr>
             <td bgcolor="#fafafa" class="font_14" width="60%" height="40px"><strong>Delegate <? if ($_REQUEST['sd']['mining_adr']!="") print "(delegate power ".$this->getDelegatePower($_REQUEST['sd']['mining_adr'])." CRC)"; ?></strong></td>
            ...
            <tr>
             <td bgcolor="#fafafa"><input class="form-control" name="txt_delegate" id="txt_delegate" value="<? print $_REQUEST['sd']['mining_adr']; ?>"></td>
