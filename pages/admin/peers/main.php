<?
  ...
  $peers=new CPeers($db, $template, $acc);
      ...
      <td height="500" align="center" valign="top" background="../../template/GIF/back_panel.png"><table width="1005" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
			...
			<?
                 $template->showHelp("Below are listed the peers this web node is connected to. A peer is a computer running the ChainRepublik software that accept / forward network packets. Running a MaskNetwork node is a great way to maintain the network security while making proffits.");
