			...
			<?
				...
				if (!isset($_REQUEST['target']))
                 ...
                 switch ($_REQUEST['act'])
	             {
					   ...
					   // Set reward
		               case "reward" : $settings->setReward($_REQUEST['txt_reward_amount']); 
		                               break;
				...
				$template->showNav($sel, 
								   "main.php?target=home", "Overview", 0, 
								   "main.php?target=sec", "Security", 0);
				
				switch ($sel)
				{
					case 1 : $settings->showHome(); 
						     break;		
						
					case 2 : $settings->showSecSettings();
						     break;
				}
