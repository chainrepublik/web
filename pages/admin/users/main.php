<?
  ...
  $users=new CUsers($db, $acc, $template);
      ...
      <td height="500" align="center" valign="top" background="../../template/GIF/back_panel.png"><table width="1005" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
			...
			<?
			    $template->showHelp("Below is the list of users in descending order of subscription. Note that the username is the same as the address name and address names are network wide unique. Click on the user name for more details.");
