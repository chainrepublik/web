        ...
        <tbody>
          <tr>
            ...
            <td width="594" align="center" valign="top">
			 ...
			 <?php
		   $template->showHelp("In aceasta pagina poti vedea situatia productiei si a utilajelor. Retine ca utilajele de productie au o durata de viata limitata si expira dupa un anumit timp. Tot aici poti vedea situatia stocurilor de materie prima si ultimele procese de productie incepute.");
		   
		   $prod->showTools();
		   $prod->showReqDD($_REQUEST['ID']);
		   ...
		   if (mysqli_num_rows($result)>0)
		   {
			  ...
			  // Product	
		      $prod->showReq($row['prod'], true);
		      
			  // Show all products
		      while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
		          $prod->showReq($row['prod'], false);
		   }
		   
		   // Show raws
		   $prod->showRaws();
				
		   // Show finite materials
		   $prod->showFinite();
				
		   // Show workers history
		   $prod->showWorkLog();
		?>
