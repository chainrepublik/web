              ...
              <tbody>
                ...
                <tr>
                  <td><img src="../../template/GIF/sep_bar_left.png" width="200" height="3" alt=""/></td>
				   ...
				   <tr>
                  <td height="80" align="right" <? if ($sel==15) print "background=\"../../template/GIF/darck_menu_label.png\"";  ?>>
                  <a href="../../market/gifts/main.php">
                  <table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                      <tr>
                        <td width="41%" align="left"><img src="../GIF/gifts_<? if ($sel==15) print "on"; else print "off"; ?>.png" width="65"/></td>
                        <td width="50%" valign="middle"><span class="<? if ($sel==15) print "bold_shadow_white_18"; else print "inset_blue_inchis_menu_18"; ?>">Gifts</span><br />
                          <span class="<? if ($sel==15) print "bold_shadow_white_12"; else print "inset_blue_inchis_menu_12"; ?>">Welcome gifts market</span></td>
                        <td width="9%"><? if ($sel==15) print "<img src=\"../../template/GIF/white_arrow.png\" width=\"16\" height=\"29\" />"; ?></td>
                      </tr>
                    </tbody>
                  </table>
                  </a>
