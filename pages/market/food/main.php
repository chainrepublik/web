      ...
      <td height="500" align="center" valign="top" background="../../template/GIF/back_panel.png"><table width="1005" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
			...
			<?
			    $template->showHelp("Below are displayed the available food offerts. You can eat only one type of food / day. A player can eat one meal every 10 minutes. The energy increases immediately. Eating can bring you up to 22.5 points of energy / day.", 70, 70);
				
				// Product
				if (!isset($_REQUEST['trade_prod'])) 
				   $_REQUEST['trade_prod']="ID_CROISANT";
				   
				// Menu
			    $food->showSelectMenu($_REQUEST['trade_prod']);
