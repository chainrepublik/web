	...
	function showContracts($prod)
	{
        ...
        <table width="540" border="0" cellspacing="0" cellpadding="5">
		  ...
		  ?>
              ...
              <tr>
              <td width="28%" height="30" class="font_14"><? print $row['rented_from']; ?></td>
              <td width="22%" align="center" class="font_14"><? print $row['rented_to']; ?></td>
              <td width="18%" align="center" class="font_14"><? print $row['days']." days"; ?></td>
              <td width="16%" align="center" class="font_14"><? print $this->kern->getAbsTime($row['tstamp']); ?></td>
              <td width="16%" align="center" class="bold_verde_14"><? print "".$row['price']; ?></td>
          </tr>
              <tr>
              <td colspan="5" ><hr></td>
              </tr>
            ...
            <tr>
              <td width="111" align="center"><table width="90" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                  ...
                  <tr>
                    <td align="center" class="simple_blue_24"><? print $row['total']; ?></td>
                  </tr>
                  <tr>
              ...
              <td width="112" align="center"><table width="90" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                  ...
                  <tr>
                    <td align="center" class="simple_blue_24"><? print "".round($row['min_price'], 2); ?></td>
                  </tr>
                  <tr>
              ...
              <td width="120" align="center"><table width="90" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                  ...
                  <tr>
                    <td align="center" class="simple_blue_24"><? print "".round($row['max_price'], 2); ?></td>
                  </tr>
                  <tr>
                    <td align="center" class="simple_blue_10">per day</td>
                  </tr>
              ...
              <td width="120" align="center"><table width="90" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                  ...
                  <tr>
                    <td align="center" class="simple_blue_24"><? print "".round($row['avg_price'], 2); ?></td>
                  </tr>
                  <tr>
                    <td align="center" class="simple_blue_10">per day</td>
                  </tr>
