      ...
      <td height="500" align="center" valign="top" background="../../template/GIF/back_panel.png"><table width="1005" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
            ...
            <?
			    $template->showHelp("Below are displayed the available wine offerts. Wine is a special product its enegy is increasing in time. A bottle of wine will give you 0.1 points of energy if you drink it in the first day. Each day you store the wine the energy increases 0.1, so if you drink the same wine bottle after 10 days, you will receive 1 point of energy.", 70, 70);
				
				// Product
				if (!isset($_REQUEST['trade_prod'])) 
				   $_REQUEST['trade_prod']="ID_WINE";
