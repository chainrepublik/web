<?php
  ...
  $bonus=new CBonuses($db, $acc, $template);
?>
        ...
        <tbody>
          <tr>
            ...
            <?php
				...
				// Show top
				$bonus->showTopPanel($cou);
				
				// Bonuses
				$bonus->showBonuses($cou);
			?>
