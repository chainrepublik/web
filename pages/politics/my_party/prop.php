      ...
      <td height="500" align="center" valign="top" background="../../template/GIF/back_panel.png"><table width="1005" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
            ...
            <?php
		        $template->showHelp("Below are displayed details about this proposal. Proposals can be voted for <strong>24 hours</strong>. Only members of party can vote a proposal. The law is aproved if <strong>minimum 51% of vote points</strong> aprove it. Not all members votes are equal. The vote points are calculated based on <strong>political influence</strong>. ");		   
		        
				// Vote
				if ($_REQUEST['act']=="vote_prop")
					$party->vote($_REQUEST['ID'], $_REQUEST['vote']);
				
				// Show panel
		        $party->showPropPage($_REQUEST['ID']);
		    ?>
