...
class CProfiles
{
	...
	function showMenu($sel=1)
	{
		?>
            ...
            <a href="../overview/main.php?ID=<? print $_REQUEST['ID']; ?>">
          ...
          <td><img src="../../template/GIF/sep_bar_left.png" width="200" height="3" alt=""/></td>
            ...
            <a href="../inventory/main.php?ID=<? print $_REQUEST['ID']; ?>">
          ...
          <tr>
            ...
            <a href="../accounting/main.php?ID=<? print $_REQUEST['ID']; ?>">
          ...
          <tr>
            ...
            <a href="../refs/main.php?ID=<? print $_REQUEST['ID']; ?>">
          ...
          <tr>
            ...
            <a href="../shares/main.php?ID=<? print $_REQUEST['ID']; ?>">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tab_partners">
              <tr>
                <td width="46%" align="center"><img src="../GIF/ico_shares_<? if ($sel==6) print "on"; else print "off"; ?>.png" /></td>
                <td width="54%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="86%" align="left"><span class="<? if ($sel==6) print "bold_shadow_white_18"; else print "inset_blue_inchis_menu_18"; ?>">Shares </span><br />
                      <span class="<? if ($sel==6) print "bold_shadow_white_12"; else print "inset_blue_inchis_menu_12"; ?>">Check player's owned shares</span></td>
                    <td width="14%">&nbsp;</td>
                  </tr>
                </table></td>
              </tr>
          ...
          <td><img src="../../template/GIF/sep_bar_left.png" width="200" height="3" alt=""/></td>
            ...
            <a href="../politics/main.php?ID=<? print $_REQUEST['ID']; ?>">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tab_settings">
              <tr>
                <td width="45%" align="center"><img src="../GIF/politics_<? if ($sel==7) print "on"; else print "off"; ?>.png" width="65px" /></td>
                <td width="55%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="86%" align="left"><span class="<? if ($sel==7) print "bold_shadow_white_18"; else print "inset_blue_inchis_menu_18"; ?>">Politics</span><br />
                      <span class="<? if ($sel==7) print "bold_shadow_white_12"; else print "inset_blue_inchis_menu_12"; ?>">Last political activity &amp; reports</span></td>
                    <td width="14%">&nbsp;</td>
                  </tr>
                </table></td>
              </tr>
          ...
          <td><img src="../../template/GIF/sep_bar_left.png" width="200" height="3" alt=""/></td>
            ...
            <a href="../military/main.php?ID=<? print $_REQUEST['ID']; ?>">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tab_settings">
              <tr>
                <td width="45%" align="center"><img src="../GIF/mil_<? if ($sel==8) print "on"; else print "off"; ?>.png" width="65px" /></td>
                <td width="55%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="86%" align="left"><span class="<? if ($sel==8) print "bold_shadow_white_18"; else print "inset_blue_inchis_menu_18"; ?>">Wars</span><br />
                      <span class="<? if ($sel==8) print "bold_shadow_white_12"; else print "inset_blue_inchis_menu_12"; ?>">Last military activity &amp; reports</span></td>
                    <td width="14%">&nbsp;</td>
                  </tr>
                </table></td>
              </tr>
          ...
          <td><img src="../../template/GIF/sep_bar_left.png" width="200" height="3" alt=""/></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tab_settings">
              <tr>
                <td width="45%" align="center"><img src="../GIF/press_<? if ($sel==9) print "on"; else print "off"; ?>.png" width="65px" /></td>
                <td width="55%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="86%" align="left"><span class="<? if ($sel==9) print "bold_shadow_white_18"; else print "inset_blue_inchis_menu_18"; ?>">Press</span><br />
                      <span class="<? if ($sel==9) print "bold_shadow_white_12"; else print "inset_blue_inchis_menu_12"; ?>">Last blog posts & comments &amp; reports</span></td>
                    <td width="14%">&nbsp;</td>
                  </tr>
                </table></td>
              </tr>
          ...
          <td><img src="../../template/GIF/sep_bar_left.png" width="200" height="3" alt=""/></td>
				 ...
				 <tr>
            <td height="80" align="right" background="../../template/GIF/label_back_<? if ($sel==10) print "on"; else print "off"; ?>.png">
            <a href="../military/main.php?ID=<? print $_REQUEST['ID']; ?>">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tab_settings">
              <tr>
                <td width="45%" align="center"><img src="../GIF/rewards_<? if ($sel==10) print "on"; else print "off"; ?>.png" width="65px" /></td>
                <td width="55%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="86%" align="left"><span class="<? if ($sel==10) print "bold_shadow_white_18"; else print "inset_blue_inchis_menu_18"; ?>">Rewards</span><br />
                      <span class="<? if ($sel==10) print "bold_shadow_white_12"; else print "inset_blue_inchis_menu_12"; ?>">Last rewards &amp; reports</span></td>
                    <td width="14%">&nbsp;</td>
                  </tr>
                </table></td>
              </tr>
