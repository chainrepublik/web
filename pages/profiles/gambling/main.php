<?
  ...
  $trading=new CTrading($db, $acc, $template, $_REQUEST['ID']);
      ...
      <td height="500" align="center" valign="top" background="../../template/GIF/back_panel.png"><table width="1005" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
		   ...
		   $template->showHelp("This page displays the gambling report of player. Players acn play a large selection of casino games like roulette, dice or blackjack.");
