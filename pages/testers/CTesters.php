              ...
              <tbody>
                ...
                <tr>
                  ...
                  <table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                      <tr>
                        <td width="42%" align="left"><img src="../GIF/buy_<? if ($sel==2) print "on"; else print "off"; ?>.png" width="70" alt=""/></td>
                        <td width="49%" valign="middle"><span class="<? if ($sel==2) print "bold_shadow_white_18"; else print "inset_blue_inchis_menu_18"; ?>">Buy</span><br /><span class="<? if ($sel==2) print "bold_shadow_white_12"; else print "inset_blue_inchis_menu_12"; ?>">Buy test coins</span></td>
