              ...
              <tbody>
                ...
                <tr>
                  ...
                  <table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                      <tr>
                        <td width="39%" align="left"><img src="../GIF/units_<? if ($sel==3) print "on"; else print "off"; ?>.png" width="65"/></td>
                        <td width="52%" valign="middle"><span class="<? if ($sel==3) print "bold_shadow_white_18"; else print "inset_blue_inchis_menu_18"; ?>">Military Units</span><br />
                          <span class="<? if ($sel==3) print "bold_shadow_white_12"; else print "inset_blue_inchis_menu_12"; ?>">Military units list</span></td>
                ...
                <tr>
                  ...
                  <table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                      <tr>
                        <td width="39%" align="left"><img src="../GIF/my_unit_<? if ($sel==4) print "on"; else print "off"; ?>.png" width="60"/></td>
                        <td width="52%" valign="middle"><span class="<? if ($sel==4) print "bold_shadow_white_18"; else print "inset_blue_inchis_menu_18"; ?>">My Unit</span><br />
                          <span class="<? if ($sel==4) print "bold_shadow_white_12"; else print "inset_blue_inchis_menu_12"; ?>">Military units list</span></td>
