      ...
      <td height="500" align="center" valign="top" background="../../template/GIF/back_panel.png"><table width="1005" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
			...
			<?
			   $template->showHelp("Below are the details of the military unit. Military units are administered by members by vote. Top members can make proposals that are put to the vote. The power of voting depends on your military influence. The network rewards military units every 24 hours. The amount of the bonus depends on the total military influence that members hold. Remember that if you want to fight, you must be a member of a military unit.");
