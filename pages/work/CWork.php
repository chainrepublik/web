              ...
              <tbody>
                ...
                <tr>
                  ...
                  <table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                      <tr>
                        <td width="42%" align="left"><img src="../GIF/workplaces_<?php if ($sel==1) print "on"; else print "off"; ?>.png" /></td>
                        <td width="49%" valign="middle"><span class="<?php if ($sel==1) print "bold_shadow_white_18"; else print "inset_blue_inchis_menu_18"; ?>">Work</span><br />
                        <span class="<?php if ($sel==1) print "bold_shadow_white_12"; else print "inset_blue_inchis_menu_12"; ?>">Check free workplaces</span></td>
                ...
                <tr>
                  ...
                  <table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                      <tr>
                        <td width="41%" align="left"><img src="../GIF/log_<?php if ($sel==2) print "on"; else print "off"; ?>.png" width="70" height="72" alt=""/></td>
                        <td width="50%" valign="middle"><span class="<?php if ($sel==2) print "bold_shadow_white_18"; else print "inset_blue_inchis_menu_18"; ?>">History</span><br />
                          <span class="<?php if ($sel==2) print "bold_shadow_white_12"; else print "inset_blue_inchis_menu_12"; ?>">Check your work history</span></td>
